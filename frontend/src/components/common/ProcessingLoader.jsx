...
export default function ProcessingLoader({ className = "", size = 100 }) {
  return (
    <div className={`processing-loader-container flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
